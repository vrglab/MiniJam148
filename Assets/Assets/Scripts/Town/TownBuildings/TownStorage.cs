...
public class TownStorage : TownBuilding
{
    ...
    public override void OnBuild()
    {
        try
        {
          ...
          Settings.Instance.SetSetting("town_max_res_storage_amnt", current_max_res_storage + 2);
        }
        catch (Exception e)
        {
            Settings.Instance.SetSetting("town_max_res_storage_amnt", 2);
        }
    }
    ...
    public override void OnDestroyed()
    {
        ...
        if ((current_max_res_storage - 2) > 0)
        {
            Settings.Instance.SetSetting("town_max_res_storage_amnt", current_max_res_storage - 2);
        }
        else
